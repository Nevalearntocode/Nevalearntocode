...
| Firebase note app             | Just a simple note app to learn how to do CRUD and file upload in firebase with nextjs                             | [view](https://github.com/Nevalearntocode/firebase-noteapp) | ...                                                  |
...
| Airbnb clone                  | A Airbnb clone also from Code With Antonio but only the design part, I also add some customizations for SEO and UX | [view](https://github.com/Nevalearntocode/airbnb)           | [view](https://note-app-82370.web.app)               |
